    ...
    <div className="min-h-screen bg-grid pt-24 pb-16">
      <div className="container">
        ...
        <div className="relative mb-6 animate-fade-in-up delay-100 flex items-center gap-3">
          <div className="h-10 w-10 bg-cover bg-center flex-shrink-0" style={{backgroundImage: 'url(https://i.postimg.cc/dV1szdFg/B0E7C9B8-C7D7-41F7-BE47-562605946559.png)'}} />
