      ...
      <section className="pt-32 pb-20 text-center relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="inline-flex items-center justify-center mb-6 animate-fade-in">
            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1024 1536'%3E%3Crect fill='%2300d4ff' width='1024' height='1536'/%3E%3Ctext x='512' y='768' font-size='300' fill='white' text-anchor='middle' dominant-baseline='middle' font-family='Arial' font-weight='bold'%3EVANQUEST%3C/text%3E%3C/svg%3E" alt="VANQUEST Pro League" className="h-24 w-auto" />
          </div>
